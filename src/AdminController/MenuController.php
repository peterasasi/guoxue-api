...
class MenuController extends BaseSymfonyApiController
{
    ...
    public function queryAll() {
        $list =  $this->menuService->queryAllBy(['status' => StatusEnum::ENABLE], ['id' => 'asc']);
    ...
    public function query($pid, PagingParams $pagingParams) {
        return $this->menuService->queryAndCount(['pid' => $pid, 'status' => StatusEnum::ENABLE], $pagingParams, ['sort' => 'desc']);
    }
     ...
     */
    public function update($id, $title, $scene, $urlType, $url = '', $icon = '', $hide = 0, $tip = '', $sort = 0) {
